...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"loadingCircles.js":[function(require,module,exports) {
function loadingCircles() {
  ...
  var circleSize = Math.sqrt(canvasWidth * canvasHeight) / 30;
  ...
  createjs.Tween.get(circles[0], {
    loop: true
  }).to({
    y: canvasHeight / 2,
    alpha: 1
  }, 1000, createjs.Ease.getPowInOut(4)) // Move up
  .to({
    x: circles[0].x
  }, 1000, createjs.Ease.getPowInOut(4)) // Move left
  .to({
    alpha: 0
  }, 500, createjs.Ease.getPowInOut(2)) // Fade out
  .to({
    alpha: 1,
    y: canvasHeight + circleSize * 2
  }, 0) // Reset position and opacity
  .wait(maxWait); // Wait to complete the loop duration

  // Animate the remaining circles with staggered starts
  circles.slice(1).forEach(function (circle, index) {
    ...
    .to({
      x: canvasWidth / 4 + circleSize + (index + 1) * circleSize * 2
    }, 1000, createjs.Ease.getPowInOut(4)) // Move left
    .to({
      alpha: 0
    }, 500, createjs.Ease.getPowInOut(2)) // Fade out
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","loadingCircles.js"], null)
//# sourceMappingURL=/loadingCircles.9acfa758.js.map