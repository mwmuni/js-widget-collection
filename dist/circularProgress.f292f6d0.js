...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"circularProgress.js":[function(require,module,exports) {
function circularProgressCircles() {
  ...
  var animationCircleSize = circleSize * 2;
  ...
  for (var i = 0; i < numCircles; i++) {
    ...
    createjs.Tween.get(circle, {
      ...
      angle: 120,
      alpha: 1
    }, duration * .5, createjs.Ease.getPowInOut(2)) // Fade in
    .to({
      angle: 300
    }, duration * .4, createjs.Ease.linear) // Rotate almost full circle
    .to({
      angle: 360,
      alpha: 0
    }, duration * .1, createjs.Ease.linear) // Rotate full circle
    .call(function () {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","circularProgress.js"], null)
//# sourceMappingURL=/circularProgress.f292f6d0.js.map