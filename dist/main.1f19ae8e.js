...
function counter() {
  ...
  setInterval(function () {
    seconds += 1;
    document.getElementById('time-counter').innerHTML = "<p>You have been here for ".concat(seconds, " second").concat(seconds > 1 ? 's' : '', ".</p>");
  }, 1000);
}
counter();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var showCodeButtons = document.querySelectorAll('.show-code-btn');
  showCodeButtons.forEach(function (button) {
    button.addEventListener('click', function () {
      var codeFile = button.getAttribute('data-code');
      console.log('Fetching:', codeFile);
      fetch(codeFile).then(function (response) {
        ...
        return console.error('Error fetching the code:', error);
      });
    });
  });
